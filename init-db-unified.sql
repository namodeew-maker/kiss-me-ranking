-- Unified identity schema for LINE Login + Multi OA + Telegram
-- PostgreSQL 14+
...
CREATE INDEX IF NOT EXISTS idx_mapping_user ON user_oa_mapping(global_user_id);
